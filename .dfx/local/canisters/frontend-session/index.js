...
import { idlFactory } from './frontend-session.did.js';
export { idlFactory } from './frontend-session.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.FRONTEND-SESSION_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./frontend-session.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the frontend-session canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./frontend-session.did.js")._SERVICE>}
 */
export const frontend-session = createActor(canisterId);
